<p align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Orbitron&weight=800&size=28&pause=1000&color=00F0FF&center=true&vCenter=true&width=800&lines=%E2%80%A2+%E2%9C%98+%F0%9D%99%B7%F0%9D%99%B0%F0%9D%9A%85%F0%9D%99%B4%F0%9D%99%BD+%7C+%F0%9F%8F%B4%E2%80%8D%E2%98%A0%EF%B8%8F+%E2%80%A2+%F0%9D%99%BD%F0%9D%9A%84%F0%9D%99%BC%F0%9D%99%B1%F0%9D%99%B4%F0%9D%9A%81+%F0%9D%99%B1%F0%9D%99%BE%F0%9D%9A%83+%F0%9D%99%BD+%E2%80%A2;Real-Time+iVasms+Live+Traffic+Engine;Autonomous+OTP+Streaming+%26+Cloudflare+Bypass;WhatsApp+%E2%80%A2+Telegram+%E2%80%A2+TikTok+%E2%80%A2+Google" alt="Raven Bot X Animated Typing Header"/>
</p>

<p align="center">
  <b>⚡ المنظومة الأقوى والأحدث لسحب وبث أرقام واختبارات منصة iVasms العالمية في الوقت الفعلي ⚡</b>
</p>

<p align="center">
  <a href="https://t.me/P_X_24"><img src="https://img.shields.io/badge/Developer-@P__X__24-00F0FF?style=for-the-badge&logo=telegram&logoColor=black" alt="Developer Telegram"/></a>
  <a href="https://t.me/Raven_xx24"><img src="https://img.shields.io/badge/Official_Channel-@Raven__xx24-FF0055?style=for-the-badge&logo=telegram&logoColor=white" alt="Official Channel"/></a>
  <img src="https://img.shields.io/badge/Python-3.10%2B-blue?style=for-the-badge&logo=python&logoColor=white" alt="Python 3.10+"/>
  <img src="https://img.shields.io/badge/Telegram_Bot_API-v7.0%2B-2CA5E0?style=for-the-badge&logo=telegram&logoColor=white" alt="Telegram Bot API"/>
  <img src="https://img.shields.io/badge/Live_Traffic-100%25_Real--Time-00FF66?style=for-the-badge" alt="Real-Time Engine"/>
...
## 🎯 ما هي الخدمة المستهدفة؟ (Targeted Platform & Services)

> ### 🌐 منصة **iVasms (SMS Traffic Monetization Platform)**
> منصة **iVasms** هي واحدة من كبرى المنصات العالمية المتخصصة في **توجيه واختبار حركة رسائل التحقق (SMS Traffic)** وتوليد الأرقام الافتراضية الدولية للشركات والمطورين. في كل ثانية، يستقبل الموقع آلاف الرسائل وأكواد الـ OTP لاختبار نطاقات أرقام (Ranges) من مختلف دول العالم.

### 📱 التطبيقات والخدمات المستهدفة بالبث والسحب اللحظي:
يقوم **RAVEN BOT X** باعتراض وقراءة البث المباشر لموقع iVasms وتصنيف الرسائل والأكواد فورياً حسب الخدمة:

| التطبيق / الخدمة (Service) | الرمز (Code) | ما يقوم به البوت لحظياً (Bot Action) |
| :--- | :---: | :--- |
| 🟢 **واتساب (WhatsApp / WhatsApp Business)** | `WS` | كشف النطاقات الشغالة فوراً، استخراج كود الـ OTP، وتوفير كود النطاق للنسخ والتفعيل بضغطة واحدة. |
| ✈️ **تليجرام (Telegram Messenger)** | `TG` | سحب رسائل تسجيل الدخول الحية، عزل أرقام التليجرام، وتنبيه القناة بالأكواد اللحظية. |
| 🎵 **تيك توك (TikTok)** | `TT` | رصد النطاقات التي تقبل إنشاء حسابات تيك توك بدون حظر، وسحب أكواد التفعيل فوراً. |
| 🔵 **فيسبوك / ميتا (Facebook / Meta)** | `FB` | استقبال رسائل التأكيد الثنائي (2FA) وأكواد إعادة تعيين الحسابات. |
| 🍎 **آبل (Apple ID / iCloud)** | `AP` | مراقبة أكواد التحقق لخدمات آبل السحابية وتفعيل الحسابات. |
| 🌐 **جوجل وجيميل (Google / Gmail)** | `GO` | التقاط أكواد تفعيل وتأكيد حسابات Google و YouTube. |
| 🎲 **منصات الألعاب والمراهنات (Betting & Gaming)** | `1xBet, Melbet` | سحب وتوجيه أكواد مواقع المراهنات العالمية والألعاب لحظة بلحظة. |
| 💬 **تطبيقات التواصل الأخرى** | `Snapchat, IMO, etc.` | دعم شامل لكافة الرسائل النصية القصيرة لجميع المنصات العالمية. |

---

## 📑 فهرس المحتويات (Table of Contents)
1. [🎯 الخدمة المستهدفة ومجال عمل المنظومة (Targeted Platform & Services)](#-ما-هي-الخدمة-المستهدفة-targeted-platform--services)
2. [📖 نظرة عامة على محرك RAVEN BOT X (Project Overview)](#-نظرة-عامة-على-المشروع-project-overview)
3. [🔄 مقارنة شاملة: النظام القديم مقابل النظام الحديث بعد التجديد (Before vs After)](#-مقارنة-شاملة-النظام-القديم-مقابل-النظام-الحديث-بعد-التجديد)
4. [🏛️ المعمارية التقنية وتدفق البيانات (System Architecture)](#-المعمارية-التقنية-وتدفق-البيانات-system-architecture)
5. [🌟 المميزات والمحركات الرئيسية (Key Features & Engine Modules)](#-المميزات-والمحركات-الرئيسية)
6. [📁 شرح هيكل المشروع والملفات (Codebase File Structure)](#-شرح-هيكل-المشروع-والملفات-codebase-file-structure)
7. [🚀 دليل التثبيت والتشغيل (Installation & Setup Guide)](#-دليل-التثبيت-والتشغيل-installation--setup-guide)
8. [👮‍♂️ دليل استخدام لوحة الإدارة (Admin Panel Manual)](#-دليل-استخدام-لوحة-الإدارة-admin-panel-manual)
9. [🛠️ استكشاف الأخطاء وحلها (Troubleshooting & FAQs)](#-استكشاف-الأخطاء-وحلها-troubleshooting--faqs)
10. [👨‍💻 المطور والشراء والطلبات الخاصة (Developer & Commercial Inquiries)](#-المطور-والشراء-والطلبات-الخاصة-developer--commercial-inquiries)
...
<details open>
<summary><b>🔍 اضغط هنا لعرض / طي جدول المقارنة التفصيلي (Click to Expand/Collapse)</b></summary>
<br/>
...
flowchart TD
    ...
    subgraph Bot_Engine["⚡ محرك بوت RAVEN BOT X (main.py)"]
...
* **محاكاة رسالة البث المباشر الفخمة كما تظهر في تيليجرام:**
...
>   
> 📩 **الرسالة المستلمة:**  
> > *Your WhatsApp code: 849-201. Do not share.*  
> ⏰ **التوقيت:** `2026-09-06 07:12:00`  
> ╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━╯  
>   
> 🔘 **`[ 📋 ZIMBABWE 3872 ]`**  
> *(زر واحد تفاعلي فقط: عند النقر عليه في تيليجرام يتم نسخ كود النطاق فوراً إلى الحافظة)*
...
```text
├── main.py                  # الملف الرئيسي: إعداد البوت، المعالجات التفاعلية، مسارات الخلفية
...
داخل ملف `main.py`، تأكد من ضبط الإعدادات التالية:
```python
